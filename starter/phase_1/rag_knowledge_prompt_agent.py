...
RAG_knowledge_prompt_agent = RAGKnowledgePromptAgent(openai_api_key= openai_api_key, persona = persona)# TODO: 2 - Instantiate RAGKnowledgePromptAgent
...
"""
#knowledge_text = "this is just a test"
chunks = RAG_knowledge_prompt_agent.chunk_text(knowledge_text) # TODO: 3 - Compute the knowledge_text the chunks
print("-------------")
embbedings = RAG_knowledge_prompt_agent.get_embedding(text = knowledge_text) # TODO: 4 - Compute the knowledge_text the chunk embbedings
print("---------")
